    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
      {sorted.map((sector, i) => (
        <ScrollReveal
          ...
          delay={0.05 + i * 0.04}
        >
          <div className="group relative rounded-2xl border border-border bg-white p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-default overflow-hidden h-full">
